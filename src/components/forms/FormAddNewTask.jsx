...
const FormAddNewTask = props => {
	...
	return (
		<form onSubmit={handleSubmit} className={css.form}>
			...
			<textarea className={clsx(css.input, css.textarea, css.status)} id='taskDescription' name='description' placeholder='Enter task description' value={values.description} onChange={handleChange} />
